...
{
    public class BirdTamagotchi : AbstractTamagotchi
    {
        ...
        private string _tamagotchiType = "BirdTamagotchi";
        ...
        public BirdTamagotchi(string name)
        {
            this.Name = name;
            Joy = 100;
            Hunger = 100;
        ...
        public BirdTamagotchi(string name, int joy, int hunger, int vigor, int special)
        { 
            this.Name = name;
            Joy = joy;
            Hunger = hunger;
        ...
        {
            return new BirdTamagotchiDecrease(this);
        }
        ...
        {
            RunAwayTimer runAwayTimer = new RunAwayTimer(this);
