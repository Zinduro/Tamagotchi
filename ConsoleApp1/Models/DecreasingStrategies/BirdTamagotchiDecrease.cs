...
{
    public class BirdTamagotchiDecrease(AbstractTamagotchi tamagotchi) : IDecrease
    {
        ...
        private int _joyDecreaseCoooldown = 1200;
        ...
        private int _hungerDecreaseCoooldown = 800;
        ...
        private int _vigorDecreaseCoooldown = 2100;
        ...
        private int _specialDecreaseCoooldown = 2500;
